...
| How do I read another object that is not linked from the current one? | **RootResolverFactory** (see [Resolver](docs/reference/resolver.md#obtaining-a-root-resolver)) |
